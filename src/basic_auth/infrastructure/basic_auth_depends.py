...
def create_basic_user_depends(db_session: Session = Depends(get_db)) -> CreateBasicUserInteractor:
    return CreateBasicUserInteractor(PostgresBasicAuthRepository(db_session), Translate())
